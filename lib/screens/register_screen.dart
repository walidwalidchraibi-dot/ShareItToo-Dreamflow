...
body: Stack(
children: [
Positioned.fill(child: IgnorePointer(child: _RegisterBackdrop(peekClear: _peekBackdrop))),
Listener(
...
Expanded(
child: Text('Dein SIT-Konto erstellen', textAlign: TextAlign.center, style: theme.textTheme.titleLarge?.copyWith(fontSize: 17, fontWeight: FontWeight.w900, color: Colors.white, height: 1.15)),
),
...
final bottomPadding = bottomBarHeight + 8 + media.padding.bottom;
final availableHeight = constraints.maxHeight - bottomPadding - 8;
...
child: Text('Miete und vermiete Dinge sicher in deiner Nähe.', textAlign: TextAlign.center, style: theme.textTheme.bodyMedium?.copyWith(color: Colors.white.withValues(alpha: 0.85), height: 1.3, fontWeight: FontWeight.w600, fontSize: 14)),
),
KeyedSubtree(
key: _cardKey,
child: _GlassCard(
...
class _StickyAuthBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      top: false,
      child: Padding(
        padding: EdgeInsets.fromLTRB(16, 8, 16, 8 + (media.padding.bottom > 0 ? 0 : 4)),
        child: Center(
          child: ConstrainedBox(
            constraints: const BoxConstraints(maxWidth: 520),
            child: Column(
              ...
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text('Schon bei SIT? ', style: theme.textTheme.bodySmall?.copyWith(color: Colors.white.withValues(alpha: 0.85), fontSize: 13)),
...
class _LegalText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final base = theme.textTheme.labelSmall?.copyWith(color: Colors.white.withValues(alpha: 0.75), height: 1.3, fontSize: 11);
  ...
  Widget build(BuildContext context) {
    ...
    return _Pressable(
      ...
      child: Padding(
        ...
        child: Text(label, style: theme.textTheme.bodySmall?.copyWith(color: BrandColors.logoAccent, fontWeight: FontWeight.w900, fontSize: 13)),
      ),
    );
  }
}
