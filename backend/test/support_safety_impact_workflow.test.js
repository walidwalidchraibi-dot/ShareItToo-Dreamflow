    ...
    { pattern: /FROM support_policy_snapshots/u, result: { rowCount: 1, rows: [{ id: policyId }] } },
    {
      ...
      result: ({ values }) => ({
        ...
        rows: [{
          ...
          user_facing_decision: values[17],
          user_facing_effect: values[18],
          user_facing_reason: values[19],
          user_facing_implementation_result: values[20],
          internal_reason: values[21],
          redress_route: values[22],
          idempotency_key: values[23],
          payload_sha256: values[24],
          approval_status: 'pending',
          implementation_status: 'not_started',
          lock_version: 1,
          decided_at: values[25],
