...
| Version und Build | `1.0.0 (2026081405)` |
...
| Android-AAB SHA-256 | `1795e54184a1467f981557cdede8b07821b1a2eeb058786569b519f6d97e6f67` |
| Android-APK SHA-256 | `565e38ffe5faa7b6f1b367281ee78d59e2e2b52f159b7ea68c439711eb3bef3d` |
...
| Synthetische Android-Rollenbuchung | `passed` auf Pixel 7 Pro, Android 16; `docs/evidence/b11/android-synthetic-role-booking-2026081405-20260814T145511Z.json` |
| Authentifizierte Android-Deep-Links | `passed` auf Pixel 7 Pro, Android 16; `docs/evidence/b11/android-authenticated-deep-links-2026081405-20260814T145800Z.json` |
| Kontrollierte Android-FCM-Diagnose | `passed` in Vordergrund, Hintergrund und bei beendetem Prozess; `docs/evidence/b11/android-controlled-fcm-2026081405-20260814T141032Z.json` |
| Android-Abmeldung und Push-Unterdrückung | `passed`; `docs/evidence/b11/android-logout-lifecycle-2026081405-20260814T145955Z.json` |
...
|---|---|---|---|---|---|---|
| Android real | offen | offen | `2026081405` | WLAN | Vermieter | offen |
| Android real | offen | offen | `2026081405` | Mobilfunk/Hotspot | Mieter | offen |
| iOS real | offen | offen | `2026081405` | WLAN | Vermieter | offen |
| iOS real | offen | offen | `2026081405` | Mobilfunk/Hotspot | Mieter | offen |
...
oder Accessibility-Matrix. Für Kandidat `2026081403` ist der getrennte
...
3. Android weiterhin über den offiziellen Testlink verwenden. Die
   Store-Installation von `2026081403` ist belegt; ein direktes APK dient nur
