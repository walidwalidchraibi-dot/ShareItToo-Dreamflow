...
| Support submission/follow-up, reports, blocking, privacy export and deletion | PARTIAL | N28 proves reachability, not these mutations. WP05 reproduced and locally corrected a missing principal/epoch boundary in privacy export, with service/widget/HTTP tests and full normal regression green. Exact clean-checkout and a successor candidate are still needed before real export acceptance. Exercise scoped disposable Staging identities, not the owner's account. |
