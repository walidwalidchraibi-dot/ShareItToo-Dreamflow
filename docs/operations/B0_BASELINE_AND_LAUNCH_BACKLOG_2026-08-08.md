...
|---|---|---|---|
| P1-01 | Flutter-Analysebestand abbauen | Codex | **in Arbeit**: 611 auf 333 Hinweise gesenkt, 0 Fehler; alle 52 ungenutzten lokalen Variablen, 24 private Zustands-/Helferhinweise und 19 unreferenzierte alte UI-/Parameterhinweise sind entfernt; sechs bereinigte Analyseklassen werden einzeln gegen Wiedereinfuehrung verriegelt; CI-Baseline jetzt 333; Nachweise unter `docs/evidence/b11/flutter-analysis-safe-batch-20260816.json`, `docs/evidence/b11/flutter-analysis-correctness-and-startup-safety-20260816.json`, `docs/evidence/b11/flutter-analysis-unused-locals-20260816.json`, `docs/evidence/b11/flutter-analysis-private-state-and-helpers-20260816.json` und `docs/evidence/b11/flutter-analysis-dead-ui-components-20260816.json` |
