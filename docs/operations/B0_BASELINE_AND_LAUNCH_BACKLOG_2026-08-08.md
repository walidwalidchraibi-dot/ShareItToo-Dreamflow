...
|---|---|---|---|
| P1-01 | Flutter-Analysebestand abbauen | Codex | **in Arbeit**: 611 auf 239 Hinweise gesenkt, 0 Fehler; alle 52 ungenutzten lokalen Variablen, 30 private Zustands-/Helferhinweise und 54 unreferenzierte alte UI-/Parameterhinweise sowie weitere 23 tote Buchungsdetail-Praesentationshinweise sind entfernt; 25 veraltete Framework-/Plugin-Verwendungen wurden auf aktuelle direkte Entsprechungen migriert oder als wirkungslose Altoption entfernt; sechs bereinigte Analyseklassen werden einzeln gegen Wiedereinfuehrung verriegelt; CI-Baseline jetzt 239; Nachweise unter `docs/evidence/b11/flutter-analysis-safe-batch-20260816.json`, `docs/evidence/b11/flutter-analysis-correctness-and-startup-safety-20260816.json`, `docs/evidence/b11/flutter-analysis-unused-locals-20260816.json`, `docs/evidence/b11/flutter-analysis-private-state-and-helpers-20260816.json`, `docs/evidence/b11/flutter-analysis-dead-ui-components-20260816.json`, `docs/evidence/b11/flutter-analysis-small-ui-and-api-cleanup-20260816.json`, `docs/evidence/b11/flutter-analysis-sharing-and-text-scaling-20260816.json`, `docs/evidence/b11/flutter-analysis-direct-api-cleanup-20260816.json`, `docs/evidence/b11/flutter-analysis-location-settings-20260816.json`, `docs/evidence/b11/flutter-analysis-radio-group-controls-20260816.json`, `docs/evidence/b11/flutter-analysis-navigation-and-web-download-20260816.json`, `docs/evidence/b11/flutter-analysis-fixed-default-parameters-20260816.json`, `docs/evidence/b11/flutter-analysis-search-overlay-dead-branch-20260816.json`, `docs/evidence/b11/flutter-analysis-create-listing-dead-state-20260816.json`, `docs/evidence/b11/flutter-analysis-booking-lists-dead-ui-20260816.json` und `docs/evidence/b11/flutter-analysis-booking-detail-legacy-presentation-20260816.json` |
