...
|---|---|---|---|
| P1-01 | Flutter-Analysebestand abbauen | Codex | **in Arbeit**: 611 auf 352 Hinweise gesenkt, 0 Fehler; nach sicheren mechanischen und korrektheitsbezogenen Batches sind alle 52 ungenutzten lokalen Variablen sowie weitere 24 private Zustands-/Helferhinweise entfernt; sechs bereinigte Analyseklassen werden einzeln gegen Wiedereinfuehrung verriegelt; CI-Baseline jetzt 352; Nachweise unter `docs/evidence/b11/flutter-analysis-safe-batch-20260816.json`, `docs/evidence/b11/flutter-analysis-correctness-and-startup-safety-20260816.json`, `docs/evidence/b11/flutter-analysis-unused-locals-20260816.json` und `docs/evidence/b11/flutter-analysis-private-state-and-helpers-20260816.json` |
