...
export function validateRw9LocalAccountProfileAuthorizationDurability({
  ...
  if (!exact(value.ratchets, {
    ...
    privacyManifestSha256:
      '35c3a08e20e4f55183649af934e9415ea8cfd0c2d3327483a518cf477daee449',
    retentionManifestSha256:
      '955a901bbaec6511d119558b953274c3e5059a97c657fdcf93f2a939523315c8',
    activeProviderEvidenceSha256:
      '364037cefb30cfd55da5f19a8e3394e0308dae7e15b3760e159f9f28e5d17f7d',
  ...
  for (const entry of value.sourceInventory) {
    const text = readHistoricalRepositoryFile(repositoryRoot, inventorySnapshotHead, entry.path, {
      sourceTexts, label: 'RW9 source-binding snapshot',
    });
    if (!/^[a-f0-9]{64}$/u.test(entry.sha256) || sha256(text) !== entry.sha256) {
